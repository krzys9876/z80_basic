...
object Main extends App {
  ...
  val program=new Program(Vector(
    ...
    LineParser.force("200 PRINT J"),
    LineParser.force("210 IF J>1 THEN GOTO 230"),
    LineParser.force("220 PRINT \"first iteration\""),
    LineParser.force("230 IF J=10 THEN PRINT \"last iteration\""),
    LineParser.force("240 PRINT J*10.01"),
    LineParser.force("250 RETURN"),
    LineParser.force("1000 PRINT \"program ends here\""),
  ))
  program.show()
  println()
